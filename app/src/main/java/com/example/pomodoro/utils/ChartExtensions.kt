...
//    val xSevDrawable: Drawable,
//    val xSevTitle: String,
)

data class VerticalChartXLabels(
    val xFirstTitle: String,
    val xSecondTitle: String,
    val xThirdTitle: String,
    val xFourTitle: String,
...
fun horizontalChartData(
    ...
    listOf(
//        Triple(
//            horizontalChartXLabels.xSevDrawable,
//            horizontalChartXLabels.xSevTitle,
//            listOfScores[6]
//        ),
//        Triple(
...
fun verticalChartData(
    context: Context,
    verticalChartXLabels: VerticalChartXLabels,
    listOfScores: List<Float> = listOf(-1F, -1F, -1F, -1F, -1F, -1F, -1F),
): List<Triple<Drawable?, String, Float>> =
    listOf(
        ...
        Triple(
            null,
            verticalChartXLabels.xFirstTitle,
            listOfScores[0]
        ),

        Triple(
            null, verticalChartXLabels.xSecondTitle,
            listOfScores[1]
        ),

        Triple(
            null, verticalChartXLabels.xThirdTitle,
            listOfScores[2]
        ),

        Triple(
            null, verticalChartXLabels.xFourTitle,
            listOfScores[3]
        ),

        Triple(
            null, verticalChartXLabels.xFiveTitle,
            listOfScores[4]
        ),

        Triple(
            null,
            verticalChartXLabels.xSixTitle,
            listOfScores[5]
        ),
        Triple(
            null, verticalChartXLabels.xSevTitle,
            listOfScores[6]
        )
    )
